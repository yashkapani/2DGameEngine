namespace Engine
{
	...
	template<typename T>
	inline bool NamedBitSet<T>::FindBitIndex(const HashedString & i_Name, unsigned int & i_BitIndex)
	{
	...
	template<typename T>
	inline bool NamedBitSet<T>::FindBitMask(const HashedString & i_Name, T & i_BitMask)
	{
