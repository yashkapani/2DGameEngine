...
public:
	...
	static Matrix CreateTransformationToWorld(Vector3 i_LocalCoords, Matrix i_Rot);
	static Matrix CreateTransformationToLocal(Vector3 i_LocalCoords, Matrix i_Rot);
